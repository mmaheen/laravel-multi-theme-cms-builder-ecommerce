    ...
    <div class="bg-no-repeat bg-contain h-[600] lg:h-175 w-full grid grid-cols-1 md:grid-cols-10"
        ...
        <div class="md:col-span-4 flex flex-col justify-center">
            <h1 class="text-4xl text-justify mb-4 text-slate-700">
                {{ $componentData['title'] ?? 'Default Overview Title' }}
            </h1>
            <p class="text-slate-500 text-justify mb-4">
                {{ $componentData['description'] ?? 'Default overview description goes here. Please update the content to reflect your product details.' }}
            </p>
            <button
