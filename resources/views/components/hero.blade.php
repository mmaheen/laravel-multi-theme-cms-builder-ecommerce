    ...
    <div class="grid grid-cols-1 md:grid-cols-10 gap-2">
        <div class="md:col-span-4 flex flex-col justify-center">
            ...
            <p class="text-justify mb-4 text-slate-500">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat incidunt quidem, obcaecati molestiae
                vel ullam reprehenderit debitis adipisci atque ratione explicabo aliquam, dolore eaque assumenda est!
                Tenetur provident repellendus adipisci.
            </p>
